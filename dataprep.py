...
# Apply text_preprocess function to test_data["X"]
test_data["X"] = test_data["X"].apply(lambda x:text_preprocess(x))
...
del count_vectorizer, X_train_countvec, tfidf_vectorizer, X_train_tfidf
...
#print(classifier.classify(test_list_countvectorizer[1]), "and", test_data["JobTitle"][1])
